...
static int do_sea(unsigned long addr, unsigned int esr, struct pt_regs *regs)
{
	...
	arm64_notify_die("", regs, SIGBUS, BUS_FIXME, siaddr, esr);
...
static const struct fault_info fault_info[] = {
	...
	{ do_sea,		SIGBUS,  BUS_FIXME,	"synchronous parity or ECC error" },
	{ do_bad,		SIGBUS,  BUS_FIXME,	"unknown 25"			},
	{ do_bad,		SIGBUS,  BUS_FIXME,	"unknown 26"			},
	{ do_bad,		SIGBUS,  BUS_FIXME,	"unknown 27"			},
	{ do_sea,		SIGBUS,  BUS_FIXME,	"level 0 synchronous parity error (translation table walk)"	},
	{ do_sea,		SIGBUS,  BUS_FIXME,	"level 1 synchronous parity error (translation table walk)"	},
	{ do_sea,		SIGBUS,  BUS_FIXME,	"level 2 synchronous parity error (translation table walk)"	},
	{ do_sea,		SIGBUS,  BUS_FIXME,	"level 3 synchronous parity error (translation table walk)"	},
	...
	{ do_bad,		SIGBUS,  BUS_FIXME,	"unknown 49"			},
					   ...
					   struct pt_regs *regs)
{
	...
	arm64_notify_die("Oops - SP/PC alignment exception", regs,
					      ...
					      struct pt_regs *regs)
{
	...
	if (!inf->fn(addr, esr, regs)) {
		...
		arm64_notify_die("", regs,
				 inf->sig, inf->code, (void __user *)addr, 0);
		rv = 0;
	}
