...
struct signal_struct {
	...
	/* exec support, notify group_exec_task when notify_count is 0 */
	int			notify_count;
...
/* If true, all threads have pending SIGKILL */
...
extern __must_check bool do_notify_parent(struct task_struct *, enum pid_type);
...
extern int send_sigqueue(struct sigqueue *,  struct pid *, int group);
