					...
					int flag)
{
	...
	if ((flag & CL_UNPRIVILEGED) && (mnt->mnt.mnt_flags & MNT_NODEV))
		mnt->mnt.mnt_flags |= MNT_LOCK_NODEV;

	if ((flag & CL_UNPRIVILEGED) && (mnt->mnt.mnt_flags & MNT_NOSUID))
		mnt->mnt.mnt_flags |= MNT_LOCK_NOSUID;

	if ((flag & CL_UNPRIVILEGED) && (mnt->mnt.mnt_flags & MNT_NOEXEC))
