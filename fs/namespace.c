					...
					int flag)
{
	...
	mnt->mnt.mnt_flags &= ~(MNT_WRITE_HOLD|MNT_MARKED|MNT_INTERNAL|MNT_PRIV_BORDER);
	/* Don't allow unprivileged users to change mount flags */
	if (flag & CL_PRIV_BORDER) {
		mnt->mnt.mnt_flags |= MNT_PRIV_BORDER | MNT_LOCK_ATIME;
